...
- **Global scope**: `/Users/aakash/Desktop/Projects/YouTube-Channel/telegram-bot-akask/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/aakash/Desktop/Projects/YouTube-Channel/telegram-bot-akask/.cursor/notes/`)
...
2. Glob `/Users/aakash/Desktop/Projects/YouTube-Channel/telegram-bot-akask/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/aakash/Desktop/Projects/YouTube-Channel/telegram-bot-akask/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/aakash/Desktop/Projects/YouTube-Channel/telegram-bot-akask/.cursor/notes/` — works in any directory
