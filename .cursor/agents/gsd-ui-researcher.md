...
Use template from `/Users/aakash/Desktop/Projects/YouTube-Channel/telegram-bot-akask/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/aakash/Desktop/Projects/YouTube-Channel/telegram-bot-akask/.cursor/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/aakash/Desktop/Projects/YouTube-Channel/telegram-bot-akask/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
